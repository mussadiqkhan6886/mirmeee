...
const Hero = () => {
  return (
    <section className='text-light relative'>
      ...
      <div className='absolute md:left-1/2 right-2 bottom-26 text-right  md:bg-transparent md:top-1/2 md:-translate-x-1/2 md:-translate-y-49 md:text-center flex items-center flex-col w-[80%]'>
        <h1 className='font-bold text-[26px] uppercase md:text-[45px] lg:text-[60px] leading-7 md:leading-14'>
