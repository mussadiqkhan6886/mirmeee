    ...
    <main className="max-w-7xl mx-auto px-4 py-16 pt-30 sm:pt-44">
      <section className="flex flex-col lg:flex-row gap-8 xl:gap-14">
        ...
        <div className="flex-1 pt-5 md:pt-0 flex flex-col gap-6">
          ...
          {/* Add to Cart */}
         <AddToCartButton id={allProducts._id} images={allProducts.images} price={allProducts.price} onSale={allProducts.onSale} name={allProducts.name} discountPrice={allProducts.discountPrice} quantity={1} variants={allProducts.variants} />
